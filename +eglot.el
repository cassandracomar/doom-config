...
;; (set-face-attribute 'eglot-semantic-namespace-face nil :inherit 'font-lock-keyword-face)
;; (set-face-attribute 'eglot-semantic-type-face nil :inherit 'font-lock-type-face)
;; (set-face-attribute 'eglot-semantic-class-face nil :inherit 'font-lock-type-face)
;; (set-face-attribute 'eglot-semantic-enum-face nil :inherit 'font-lock-type-face)
;; (set-face-attribute 'eglot-semantic-enumMember-face nil :inherit 'font-lock-constant-face)
;; (set-face-attribute 'eglot-semantic-interface-face nil :inherit 'font-lock-type-face)
;; (set-face-attribute 'eglot-semantic-struct-face nil :inherit 'font-lock-type-face)
;; (set-face-attribute 'eglot-semantic-typeParameter-face nil :inherit 'font-lock-variable-name-face)
;; (set-face-attribute 'eglot-semantic-parameter-face nil :inherit 'font-lock-variable-use-face)
;; (set-face-attribute 'eglot-semantic-variable-face nil :inherit 'font-lock-variable-use-face)
;; (set-face-attribute 'eglot-semantic-property-face nil :inherit 'font-lock-property-use-face)
;; (set-face-attribute 'eglot-semantic-enumMember-face nil :inherit 'font-lock-constant-face)
;; (set-face-attribute 'eglot-semantic-event-face nil :inherit 'font-lock-variable-name-face)
;; (set-face-attribute 'eglot-semantic-function-face nil :inherit 'font-lock-function-name-face)
;; (set-face-attribute 'eglot-semantic-method-face nil :inherit 'font-lock-function-name-face)
;; (set-face-attribute 'eglot-semantic-macro-face nil :inherit 'font-lock-preprocessor-face)
;; (set-face-attribute 'eglot-semantic-keyword-face nil :inherit 'font-lock-keyword-face)
;; (set-face-attribute 'eglot-semantic-modifier-face nil :inherit 'font-lock-function-name-face)
;; (set-face-attribute 'eglot-semantic-comment-face nil :inherit 'font-lock-comment-face)
;; (set-face-attribute 'eglot-semantic-string-face nil :inherit 'font-lock-string-face)
;; (set-face-attribute 'eglot-semantic-number-face nil :inherit 'font-lock-constant-face)
;; (set-face-attribute 'eglot-semantic-regexp-face nil :inherit 'font-lock-preprocessor-face)
;; (set-face-attribute 'eglot-semantic-operator-face nil :inherit 'font-lock-keyword-face)
;; (set-face-attribute 'eglot-semantic-decorator-face nil :inherit 'font-lock-type-face))
;; (set-face-attribute 'eglot-semantic-declaration-face nil :inherit 'font-lock-function-name-face)
;; (set-face-attribute 'eglot-semantic-definition-face nil :inherit 'font-lock-function-name-face)
;; (set-face-attribute 'eglot-semantic-readonly-face nil :inherit 'font-lock-constant-face)
;; (set-face-attribute 'eglot-semantic-static-face nil :inherit 'font-lock-keyword-face)
;; (set-face-attribute 'eglot-semantic-deprecated-face nil :inherit 'eglot-diagnostic-tag-deprecated-face)
;; (set-face-attribute 'eglot-semantic-abstract-face nil :inherit 'font-lock-keyword-face)
;; (set-face-attribute 'eglot-semantic-async-face nil :inherit 'font-lock-preprocessor-face)
;; (set-face-attribute 'eglot-semantic-modification-face nil :inherit 'font-lock-function-name-face)
;; (set-face-attribute 'eglot-semantic-documentation-face nil :inherit 'font-lock-doc-face)
;; (set-face-attribute 'eglot-semantic-defaultLibrary-face nil :inherit 'font-lock-builtin-face)
