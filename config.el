...
;;  :custom
;;  (evil-surround-pairs-alist (let ((pairs
;;                                    (copy-tree
...
the start of the line."
  ...
  (setq agent-shell-openai-authentication
        ...
        '(((name . "emacs")
          ...
          ((name . "grafana")
           (command . "uvx")
           (args . ("--default-index=https://pypi.drwholdings.com" "mcp-grafana"))
          ...
          ((name . "mcp-atlassian")
           (command . "uvx")
           (args . ("--default-index=https://pypi.drwholdings.com" "mcp-atlassian"))
