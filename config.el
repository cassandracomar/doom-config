...
(use-package! eglot
  ...
  :custom-face
  (font-lock-variable-use-face ((t (:foreground "#fda135"))))
  (font-lock-type-face ((t (:foreground "#5c9cff"))))
  (font-lock-type-parameter-face ((t (:foreground "#66d9ef"))))
  (font-lock-constant-face ((t (:foreground "#e3871b"))))
  ...
  (eglot-semantic-enumMember ((t (:inherit font-lock-constant-face :slant italic))))
  (eglot-semantic-interface ((t (:inherit elisp-symbol-role))))
  (eglot-semantic-struct ((t (:inherit elisp-major-mode-name))))
  (eglot-semantic-typeParameter ((t (:inherit font-lock-type-parameter-face :slant italic))))
  (eglot-semantic-parameter ((t (:inherit font-lock-variable-use-face :slant italic))))
  ...
  (eglot-semantic-event ((t (:inherit font-lock-type-parameter-face))))
  ...
  (eglot-semantic-declaration ((t (:underline t :slant nil))))
  (eglot-semantic-definition ((t (:underline t :slant nil))))
