...
(use-package! eglot
  ...
  ;; (eglot-semantic-enumMember-face ((t (:inherit font-lock-constant-face))))
  ;; (eglot-semantic-event-face ((t (:inherit font-lock-variable-name-face))))
  ;; (eglot-semantic-function-face ((t (:inherit font-lock-function-name-face))))
  ;; (eglot-semantic-method-face ((t (:inherit font-lock-function-name-face))))
  ;; (eglot-semantic-macro-face ((t (:inherit font-lock-preprocessor-face))))
  ;; (eglot-semantic-keyword-face ((t (:inherit font-lock-keyword-face))))
  ;; (eglot-semantic-modifier-face ((t (:inherit font-lock-function-name-face))))
  ...
  ;; (eglot-semantic-abstract-face ((t (:inherit font-lock-keyword-face))))
