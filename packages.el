...
(package! claude-code-ide-extras :recipe (:host github :repo "acmorrow/claude-code-ide-extras" :files ("claude-code-ide-extras-common.el" "claude-code-ide-extras-emacs.el")) :pin "56ad113f7206378ce23238dd7932737513a01748")
