...
(package! jsonnet-language-server :recipe (:host github :repo "grafana/jsonnet-language-server" :files ("editor/emacs/*.el")) :pin "546040b5f00a0cc09888aaa08257d7d3c496d7b3")
